...
export function TableSettlement({
  searchComponent,
  paginatedComponent,
  filterComponent,
  buttonComponent,
  ...
  actions,
  columns,
}: Readonly<DataTableProps<IDataSettlement>>) {
  const [sortColumn, setSortColumn] = useState<keyof IDataSettlement | null>(
    null
  );
  const [sortDirection, setSortDirection] = useState<"asc" | "desc">("asc");
  const handleSort = (column: keyof IDataSettlement) => {
