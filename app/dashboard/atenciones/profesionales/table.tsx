...
import { IDataProfessional } from "@/app/api/professionals/interface/professionals.interface";
...
export function TableProfessionals({
  ...
  actions,
  columns,
}: Readonly<DataTableProps<IDataProfessional>>) {
  const [sortColumn, setSortColumn] = useState<keyof IDataProfessional | null>(null);
  const [sortDirection, setSortDirection] = useState<"asc" | "desc">("asc");
  const handleSort = (column: keyof IDataProfessional) => {
